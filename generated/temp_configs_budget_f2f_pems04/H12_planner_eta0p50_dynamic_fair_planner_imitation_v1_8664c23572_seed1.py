...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/PEMS04/H12/budget_f2f/planner_eta0p50_dynamic_fair_planner_imitation_v1_8664c23572/seed1")
...
CFG.MODEL.PARAM["run_signature"] = 'ds=PEMS04|H=12|seed=1|variant=chain_budget_conditioned_adaptive_f2f_kasa_condition_adapter_token_loss|mode=sample|forced=none|phase=planner|loss=dynamic_fair|cands=12+6-12+3-12+3-6-12|gran=sample|eta=0.5000|cost=normalized_static_cost|cost_file=none|code=9ed20be-843a343138|epochs=50|plr=0.002|blr=default|lmid=1.0|lim=1.0|lbud=0.0|train_etas=0.00+0.25+0.50+0.75+1.00|tag=planner_imitation_v1'
CFG.MODEL.PARAM["experiment_tag"] = 'planner_eta0p50_dynamic_fair_planner_imitation_v1_8664c23572'
...
CFG.DESCRIPTION = "budget_f2f planner_eta0p50_dynamic_fair_planner_imitation_v1_8664c23572 H=12 seed=1"
