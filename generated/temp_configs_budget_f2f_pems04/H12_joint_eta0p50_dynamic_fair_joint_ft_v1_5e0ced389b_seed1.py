...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/PEMS04/H12/budget_f2f/joint_eta0p50_dynamic_fair_joint_ft_v1_5e0ced389b/seed1")
...
CFG.TRAIN.FINETUNE_FROM = 'checkpoints/PEMS04/H12/budget_f2f/planner_eta0p50_dynamic_fair_planner_imitation_v1_8664c23572/seed1/7e30f00d4a6dd0c89be3f3158c54ad68/BudgetConditionedAdaptiveF2FNet_best_val_MAE.pt'
...
CFG.MODEL.PARAM["route_selection_mode"] = 'batch'
CFG.MODEL.PARAM["route_granularity"] = 'batch'
CFG.MODEL.PARAM["route_cost_type"] = 'normalized_static_cost'
CFG.MODEL.PARAM["planner_hidden_dim"] = 64
CFG.MODEL.PARAM["training_phase"] = 'joint'
CFG.MODEL.PARAM["route_sampling"] = 'none'
CFG.MODEL.PARAM["loss_mode"] = 'dynamic_fair'
CFG.MODEL.PARAM["freeze_forecasting_backbone"] = False
...
CFG.MODEL.PARAM["lambda_budget"] = 0.05
...
CFG.MODEL.PARAM["planner_lr"] = 0.001
CFG.MODEL.PARAM["backbone_lr"] = 0.0002
CFG.MODEL.PARAM["run_signature"] = 'ds=PEMS04|H=12|seed=1|variant=chain_budget_conditioned_adaptive_f2f_kasa_condition_adapter_token_loss|mode=batch|forced=none|phase=joint|loss=dynamic_fair|cands=12+6-12+3-12+3-6-12|gran=batch|eta=0.5000|cost=normalized_static_cost|cost_file=none|code=9ed20be-843a343138|epochs=30|plr=0.001|blr=0.0002|lmid=1.0|lim=1.0|lbud=0.05|train_etas=0.00+0.25+0.50+0.75+1.00|tag=joint_ft_v1'
CFG.MODEL.PARAM["experiment_tag"] = 'joint_eta0p50_dynamic_fair_joint_ft_v1_5e0ced389b'
CFG.MODEL.PARAM["oracle_file"] = 'results/pems04_budget_f2f_oracle_train_rawscale.json'
CFG.MODEL.PARAM["init_checkpoint"] = 'checkpoints/PEMS04/H12/budget_f2f/planner_eta0p50_dynamic_fair_planner_imitation_v1_8664c23572/seed1/7e30f00d4a6dd0c89be3f3158c54ad68/BudgetConditionedAdaptiveF2FNet_best_val_MAE.pt'

CFG.DESCRIPTION = "budget_f2f joint_eta0p50_dynamic_fair_joint_ft_v1_5e0ced389b H=12 seed=1"
