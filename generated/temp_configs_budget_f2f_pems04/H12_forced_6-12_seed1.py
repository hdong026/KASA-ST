...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/PEMS04/H12/budget_f2f/forced_6-12/seed1")
...
CFG.MODEL.PARAM["run_signature"] = 'ds=PEMS04|H=12|seed=1|variant=chain_budget_conditioned_adaptive_f2f_kasa_condition_adapter_token_loss|mode=forced|forced=6,12|phase=supernet|loss=baseline_compatible|cands=12+6-12+3-12+3-6-12|gran=batch|eta=0.5000|cost=normalized_static_cost|cost_file=none'
CFG.MODEL.PARAM["experiment_tag"] = 'forced_6-12'
CFG.MODEL.PARAM["forced_route"] = [6, 12]

CFG.DESCRIPTION = "budget_f2f forced_6-12 H=12 seed=1"
