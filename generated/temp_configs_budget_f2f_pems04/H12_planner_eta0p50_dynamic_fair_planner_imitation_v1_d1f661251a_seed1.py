...
CFG.DESCRIPTION = "ChainForecasting on PeMS04 12→12"
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/PEMS04/H12/budget_f2f/planner_eta0p50_dynamic_fair_planner_imitation_v1_d1f661251a/seed1")
...
CFG.MODEL.NAME = 'BudgetConditionedAdaptiveF2FNet'
from basicts.archs import BudgetConditionedAdaptiveF2FNet
CFG.MODEL.ARCH = BudgetConditionedAdaptiveF2FNet
CFG.MODEL.PARAM.pop("chain_lengths", None)
from basicts.data import IndexedTimeSeriesForecastingDataset
CFG.DATASET_CLS = IndexedTimeSeriesForecastingDataset
CFG.TRAIN.NUM_EPOCHS = 50
CFG.TRAIN.FINETUNE_FROM = 'checkpoints/PEMS04/H12/budget_f2f/supernet_eta0p50_dynamic_fair_rawscale_loss_v2_60f53aa1c6/seed1/b5678fda5e8d94ed028c6c8bb073461d/BudgetConditionedAdaptiveF2FNet_best_val_MAE.pt'
CFG.TRAIN.FINETUNE_STRICT_LOAD = False
...
CFG.MODEL.PARAM["chain_loss_mode"] = 'dynamic_fair'
CFG.MODEL.PARAM["chain_loss_weights"] = None
CFG.MODEL.PARAM["inference_intensity"] = 0.5
CFG.MODEL.PARAM["route_selection_mode"] = 'sample'
CFG.MODEL.PARAM["route_granularity"] = 'sample'
CFG.MODEL.PARAM["route_cost_type"] = 'normalized_static_cost'
CFG.MODEL.PARAM["planner_hidden_dim"] = 64
CFG.MODEL.PARAM["training_phase"] = 'planner'
CFG.MODEL.PARAM["route_sampling"] = 'none'
CFG.MODEL.PARAM["loss_mode"] = 'dynamic_fair'
CFG.MODEL.PARAM["freeze_forecasting_backbone"] = True
CFG.MODEL.PARAM["planner_training_intensities"] = [0.0, 0.25, 0.5, 0.75, 1.0]
CFG.MODEL.PARAM["lambda_mid"] = 1.0
CFG.MODEL.PARAM["lambda_imitation"] = 1.0
CFG.MODEL.PARAM["lambda_budget"] = 0.0
...
CFG.MODEL.PARAM["candidate_routes"] = [[12], [6, 12], [3, 12], [3, 6, 12]]
CFG.MODEL.PARAM["planner_lr"] = 0.002
CFG.MODEL.PARAM["run_signature"] = 'ds=PEMS04|H=12|seed=1|variant=chain_budget_conditioned_adaptive_f2f_kasa_condition_adapter_token_loss|mode=sample|forced=none|phase=planner|loss=dynamic_fair|cands=12+6-12+3-12+3-6-12|gran=sample|eta=0.5000|cost=normalized_static_cost|cost_file=none|code=9ed20be-a9a1049a7b|epochs=50|plr=0.002|blr=default|lmid=1.0|lim=1.0|lbud=0.0|train_etas=0.00+0.25+0.50+0.75+1.00|tag=planner_imitation_v1'
CFG.MODEL.PARAM["experiment_tag"] = 'planner_eta0p50_dynamic_fair_planner_imitation_v1_d1f661251a'
CFG.MODEL.PARAM["oracle_file"] = 'results/pems04_budget_f2f_oracle_train_rawscale.json'
CFG.MODEL.PARAM["init_checkpoint"] = 'checkpoints/PEMS04/H12/budget_f2f/supernet_eta0p50_dynamic_fair_rawscale_loss_v2_60f53aa1c6/seed1/b5678fda5e8d94ed028c6c8bb073461d/BudgetConditionedAdaptiveF2FNet_best_val_MAE.pt'

CFG.DESCRIPTION = "budget_f2f planner_eta0p50_dynamic_fair_planner_imitation_v1_d1f661251a H=12 seed=1"
