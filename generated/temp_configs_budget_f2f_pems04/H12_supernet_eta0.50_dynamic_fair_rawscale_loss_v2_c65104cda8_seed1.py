...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/PEMS04/H12/budget_f2f/supernet_eta0.50_dynamic_fair_rawscale_loss_v2_c65104cda8/seed1")
...
CFG.MODEL.PARAM["run_signature"] = 'ds=PEMS04|H=12|seed=1|variant=chain_budget_conditioned_adaptive_f2f_kasa_condition_adapter_token_loss|mode=batch|forced=none|phase=supernet|loss=dynamic_fair|cands=12+6-12+3-12+3-6-12|gran=batch|eta=0.5000|cost=normalized_static_cost|cost_file=none|code=2c0e0d5-8eb4586c0f|tag=rawscale_loss_v2'
CFG.MODEL.PARAM["experiment_tag"] = 'supernet_eta0.50_dynamic_fair_rawscale_loss_v2_c65104cda8'

CFG.DESCRIPTION = "budget_f2f supernet_eta0.50_dynamic_fair_rawscale_loss_v2_c65104cda8 H=12 seed=1"
