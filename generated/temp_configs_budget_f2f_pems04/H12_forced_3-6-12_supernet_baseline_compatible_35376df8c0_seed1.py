...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/PEMS04/H12/budget_f2f/forced_3-6-12_supernet_baseline_compatible_35376df8c0/seed1")
...
CFG.MODEL.PARAM["chain_loss_mode"] = 'baseline_compatible'
CFG.MODEL.PARAM["chain_loss_weights"] = None
CFG.MODEL.PARAM["inference_intensity"] = 0.5
CFG.MODEL.PARAM["route_selection_mode"] = 'forced'
...
CFG.MODEL.PARAM["training_phase"] = 'supernet'
CFG.MODEL.PARAM["route_sampling"] = 'none'
CFG.MODEL.PARAM["loss_mode"] = 'baseline_compatible'
...
CFG.MODEL.PARAM["run_signature"] = 'ds=PEMS04|H=12|seed=1|variant=chain_budget_conditioned_adaptive_f2f_kasa_condition_adapter_token_loss|mode=forced|forced=3,6,12|phase=supernet|loss=baseline_compatible|cands=12+6-12+3-12+3-6-12|gran=batch|eta=0.5000|cost=normalized_static_cost|cost_file=none|code=2c0e0d5-8eb4586c0f|tag=rawscale_loss_v2'
CFG.MODEL.PARAM["experiment_tag"] = 'forced_3-6-12_supernet_baseline_compatible_35376df8c0'
CFG.MODEL.PARAM["forced_route"] = [3, 6, 12]

CFG.DESCRIPTION = "budget_f2f forced_3-6-12_supernet_baseline_compatible_35376df8c0 H=12 seed=1"
