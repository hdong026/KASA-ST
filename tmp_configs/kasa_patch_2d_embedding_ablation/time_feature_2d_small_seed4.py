...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 4
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "kasa_patch_2d_embedding_ablation", "time_feature_2d_small_seed4")
...
CFG.MODEL.PARAM["patch_embedding_mode"] = 'time_feature_2d'
CFG.MODEL.PARAM["patch_data_input_mode"] = 'all'
CFG.MODEL.PARAM["patch_feature_dim"] = 16
