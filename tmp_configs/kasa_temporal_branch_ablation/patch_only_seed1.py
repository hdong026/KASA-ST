...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "kasa_temporal_branch_ablation", "patch_only_seed1")
...
CFG.MODEL.PARAM["use_downsample_branch"] = False
CFG.MODEL.PARAM["use_linear_residual_branch"] = False
