...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/all_baselines_horizon_pems04/h48/STDN_seed1")
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 48
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 49))
CFG.MODEL.PARAM["args"]["Training"]["num_his"] = 12
CFG.MODEL.PARAM["args"]["Training"]["num_pred"] = 48
CFG.MODEL.PARAM["args"]["Training"]["T_miss_len"] = 48
