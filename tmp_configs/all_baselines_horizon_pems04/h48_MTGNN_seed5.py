...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "baselines", "MTGNN_PEMS04_" + str(CFG.TRAIN.NUM_EPOCHS))
# train data
...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 5
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/all_baselines_horizon_pems04/h48/MTGNN_seed5")
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 48
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 49))
CFG.MODEL.PARAM["out_dim"] = 48
CFG.MODEL.PARAM["seq_length"] = 12
CFG.TRAIN.CL.PREDICTION_LENGTH = 48
