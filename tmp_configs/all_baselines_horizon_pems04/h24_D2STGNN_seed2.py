...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 2
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/all_baselines_horizon_pems04/h24/D2STGNN_seed2")
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 24
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 25))
CFG.MODEL.PARAM["input_seq_len"] = 12
CFG.MODEL.PARAM["output_seq_len"] = 24
