...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "baselines", "DGCRN_PEMS04_" + str(CFG.TRAIN.NUM_EPOCHS))
# train data
...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 3
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/all_baselines_horizon_pems04/h24/DGCRN_seed3")
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 24
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 25))
CFG.MODEL.PARAM["seq_length"] = 24
