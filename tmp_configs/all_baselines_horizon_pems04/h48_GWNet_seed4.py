...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "baselines", "GWNet_PEMS04_" + str(CFG.TRAIN.NUM_EPOCHS))
# train data
...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 4
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/all_baselines_horizon_pems04/h48/GWNet_seed4")
CFG.DATASET_INPUT_LEN = 12
