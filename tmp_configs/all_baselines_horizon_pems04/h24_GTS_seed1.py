...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/all_baselines_horizon_pems04/h24/GTS_seed1")
CFG.DATASET_INPUT_LEN = 12
...
import torch.nn.functional as F
from basicts.utils.serialization import load_pkl
_gts_data = load_pkl("datasets/PEMS04/data_in12_out24.pkl")
_gts_index = load_pkl("datasets/PEMS04/index_in12_out24.pkl")
