...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "baselines", "StemGNN_PEMS04_" + str(CFG.TRAIN.NUM_EPOCHS))
# train data
...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 2
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/all_baselines_horizon_pems04/h12/StemGNN_seed2")
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 12
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 13))
CFG.MODEL.PARAM["time_step"] = 12
CFG.MODEL.PARAM["horizon"] = 12
