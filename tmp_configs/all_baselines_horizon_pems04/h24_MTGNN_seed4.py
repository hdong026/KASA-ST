...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 4
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/all_baselines_horizon_pems04/h24/MTGNN_seed4")
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 24
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 25))
CFG.MODEL.PARAM["out_dim"] = 24
CFG.MODEL.PARAM["seq_length"] = 12
CFG.TRAIN.CL.PREDICTION_LENGTH = 24
