...
# ===== paper_efficiency two_stage overrides =====
CFG.ENV.SEED = 1
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 12
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/paper_efficiency/two_stage_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
...
CFG.MODEL.PARAM["chain_lengths"] = [6, 12]
...
CFG.MODEL.PARAM["progressive_spatial_ratios"] = [0.5, 1.0]
CFG.MODEL.PARAM["progressive_spatial_topks"] = [16, 32]
CFG.MODEL.PARAM["progressive_spatial_alphas"] = [0.06, 0.1]
