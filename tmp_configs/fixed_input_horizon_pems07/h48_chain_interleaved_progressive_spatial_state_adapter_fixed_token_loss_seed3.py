...
CFG.DESCRIPTION = "ChainForecasting on PEMS07 12→12"
...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 3
CFG.DATASET_NAME = "PEMS07"
CFG.TRAIN.DATA.DIR = "datasets/PEMS07"
CFG.VAL.DATA.DIR = "datasets/PEMS07"
CFG.TEST.DATA.DIR = "datasets/PEMS07"
CFG.MODEL.PARAM["adj_mx_path"] = "datasets/PEMS07/adj_mx.pkl"
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 48
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_pems07/h48/chain_interleaved_progressive_spatial_state_adapter_fixed_token_loss_seed3")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
