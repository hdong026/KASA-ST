...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 3
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "kasa_unified_graph_spectral", "offline_low_high_k32_online_calib_seed3")
CFG.TRAIN.DATA.DIR = 'datasets/PEMS04_graph_spectral_k32_lowhigh'
CFG.VAL.DATA.DIR = 'datasets/PEMS04_graph_spectral_k32_lowhigh'
CFG.TEST.DATA.DIR = 'datasets/PEMS04_graph_spectral_k32_lowhigh'
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3, 4]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["input_dim"] = 5
CFG.MODEL.PARAM["adj_mx_path"] = os.path.join('datasets/PEMS04_graph_spectral_k32_lowhigh', "adj_mx.pkl")
...
CFG.MODEL.PARAM["main_input_dim"] = 5
CFG.MODEL.PARAM["use_graph_spectral_calibration"] = True
CFG.MODEL.PARAM["graph_spectral_calibration_mode"] = 'residual_safe_low_high'
