...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 5
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "kasa_unified_graph_spectral", "online_calib_seed5")
...
CFG.MODEL.PARAM["adj_mx_path"] = os.path.join('datasets/PEMS04', "adj_mx.pkl")
