...
CFG.DESCRIPTION = "ChainForecasting on PEMS-BAY 12→12"
...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 5
CFG.DATASET_NAME = "PEMS-BAY"
CFG.TRAIN.DATA.DIR = "datasets/PEMS-BAY"
CFG.VAL.DATA.DIR = "datasets/PEMS-BAY"
CFG.TEST.DATA.DIR = "datasets/PEMS-BAY"
CFG.MODEL.PARAM["adj_mx_path"] = "datasets/PEMS-BAY/adj_mx.pkl"
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 48
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_pems_bay/h48/chain_interleaved_progressive_spatial_state_adapter_fixed_token_loss_seed5")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
