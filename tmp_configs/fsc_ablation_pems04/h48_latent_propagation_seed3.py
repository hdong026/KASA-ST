...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fsc_ablation_pems04/h48/latent_propagation_seed3")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
...
CFG.MODEL.PARAM["propagation_mode"] = 'latent'
...
CFG.MODEL.PARAM["latent_prop_dim"] = 32
