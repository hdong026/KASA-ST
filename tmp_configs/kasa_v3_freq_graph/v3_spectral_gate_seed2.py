...
CFG.DESCRIPTION = "KASA v3 model configuration"
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "KASA_v3"
CFG.MODEL.ARCH = KASA_v3
CFG.MODEL.PARAM = {
    "node_size": 307,
...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 2
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "kasa_v3_freq_graph", "v3_spectral_gate_seed2")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["use_frequency_guided_graph"] = True
CFG.MODEL.PARAM["use_cross_st_gate"] = True
CFG.MODEL.PARAM["use_spectral_decomp_gate"] = True
