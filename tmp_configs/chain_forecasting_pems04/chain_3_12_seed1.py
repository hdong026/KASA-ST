...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "chain_forecasting_pems04", "chain_3_12_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["chain_lengths"] = [3, 12]
CFG.MODEL.PARAM["chain_loss_weights"] = [0.2, 1.0]
CFG.MODEL.PARAM["use_final_spatial_refine"] = True
CFG.MODEL.PARAM["use_downsample_memory"] = True
