...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 4
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "kasa_post_spatial_ablation", "pre_spatial_on_post_hybrid_seed4")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["post_spatial_mode"] = 'hybrid'
CFG.MODEL.PARAM["use_pre_temporal_spatial_enhancement"] = True
