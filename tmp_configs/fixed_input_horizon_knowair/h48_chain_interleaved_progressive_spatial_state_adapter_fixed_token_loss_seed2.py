...
CFG.DESCRIPTION = "ChainForecasting on KnowAir 12→12"
CFG.RUNNER = ChainForecastingRunner
CFG.DATASET_CLS = TimeSeriesForecastingDataset
CFG.DATASET_NAME = "KnowAir"
CFG.DATASET_TYPE = "Air quality"
...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 2
CFG.DATASET_NAME = "KnowAir"
CFG.TRAIN.DATA.DIR = "datasets/KnowAir"
CFG.VAL.DATA.DIR = "datasets/KnowAir"
CFG.TEST.DATA.DIR = "datasets/KnowAir"
CFG.MODEL.PARAM["adj_mx_path"] = "datasets/KnowAir/adj_mx.pkl"
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 48
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_knowair/h48/chain_interleaved_progressive_spatial_state_adapter_fixed_token_loss_seed2")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
