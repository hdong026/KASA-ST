...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "kasa_v3_freqgate", "tfstgn_full_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["use_tf"] = True
CFG.MODEL.PARAM["use_fs"] = True
CFG.MODEL.PARAM["use_gate"] = True
CFG.MODEL.PARAM["n_bands"] = 4
from basicts.losses import masked_mae_freq_loss
CFG.TRAIN.LOSS = masked_mae_freq_loss
