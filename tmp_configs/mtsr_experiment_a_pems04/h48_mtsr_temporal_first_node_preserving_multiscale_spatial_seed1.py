...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/mtsr_experiment_a_pems04/h48/mtsr_temporal_first_node_preserving_multiscale_spatial_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
...
CFG.MODEL.PARAM["propagation_mode"] = 'forecast_state'
CFG.MODEL.PARAM["spatial_placement"] = 'temporal_first_multiscale'
...
CFG.MODEL.PARAM["chain_supervision_source"] = 'temporal_chain'
CFG.MODEL.PARAM["spatial_stage_loss_weights"] = [0.0, 0.0, 0.0]
CFG.MODEL.PARAM["post_chain_spatial_ratios"] = [0.25, 0.5, 1.0]
CFG.MODEL.PARAM["post_chain_spatial_topks"] = [8, 16, 32]
CFG.MODEL.PARAM["post_chain_spatial_alphas"] = [0.03, 0.06, 0.1]
