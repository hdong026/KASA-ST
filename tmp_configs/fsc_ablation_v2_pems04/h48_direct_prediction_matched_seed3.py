...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fsc_ablation_v2_pems04/h48/direct_prediction_matched_seed3")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
...
CFG.MODEL.PARAM["chain_lengths"] = [48]
...
CFG.MODEL.PARAM["architecture_mode"] = 'direct_matched'
CFG.MODEL.PARAM["matched_stage_lengths"] = [12, 24, 48]
CFG.MODEL.PARAM["matched_num_layer"] = 2
CFG.MODEL.PARAM["matched_hidden_dim"] = 32
CFG.MODEL.PARAM["chain_loss_weights"] = [1.0]
