...
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 12
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fsc_ablation_v2_pems04/h12/direct_prediction_matched_seed5")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
...
CFG.MODEL.PARAM["chain_lengths"] = [12]
...
CFG.MODEL.PARAM["matched_stage_lengths"] = [3, 6, 12]
