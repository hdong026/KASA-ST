...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fsc_ablation_v2_pems04/h24/direct_prediction_matched_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
...
CFG.MODEL.PARAM["chain_lengths"] = [24]
...
CFG.MODEL.PARAM["matched_stage_lengths"] = [6, 12, 24]
