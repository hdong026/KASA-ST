...
from basicts.runners import C2FTimeSeriesForecastingRunner
...
# ================= general ================= #
CFG.DESCRIPTION = "C2F-v2 safe guided correction configuration"
CFG.RUNNER = C2FTimeSeriesForecastingRunner
...
CFG.MODEL.PARAM = {
    ...
    "c2f_mode": "safe_guided_correction",
    "coarse_len": 3,
    "c2f_upsample_mode": "linear",
    "use_coarse_loss": True,
    "coarse_loss_weight": 0.1,
    "c2f_correction_input": "base_coarse_diff",
    "c2f_correction_hidden_dim": 16,
    "c2f_gamma_init": 0.0,
    "c2f_stopgrad_coarse_in_correction": False,
    "c2f_stopgrad_base_in_correction": False,
    "c2f_use_base_downsample_fine": True,
    "c2f_use_linear_residual": True,
    "c2f_coarse_from": "downsample_output",
...
# ===== c2f_v2_pems04_ablation overrides (auto-generated) =====
CFG.ENV.SEED = 1
if hasattr(CFG, 'SEED'):
    CFG.SEED = 1
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "c2f_v2_pems04_ablation", "c2f_v2_fc6_safe_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
...
CFG.MODEL.PARAM["use_coarse_loss"] = True
CFG.MODEL.PARAM["coarse_loss_weight"] = 0.1
CFG.MODEL.PARAM["c2f_upsample_mode"] = 'linear'
CFG.MODEL.PARAM["c2f_correction_input"] = 'base_coarse_diff'
CFG.MODEL.PARAM["c2f_correction_hidden_dim"] = 16
CFG.MODEL.PARAM["c2f_gamma_init"] = 0.0
CFG.MODEL.PARAM["c2f_stopgrad_coarse_in_correction"] = False
CFG.MODEL.PARAM["c2f_stopgrad_base_in_correction"] = False
CFG.MODEL.PARAM["c2f_use_base_downsample_fine"] = True
CFG.MODEL.PARAM["c2f_use_linear_residual"] = True
CFG.MODEL.PARAM["c2f_coarse_from"] = 'downsample_output'
...
CFG.MODEL.PARAM["c2f_mode"] = 'safe_guided_correction'
CFG.MODEL.PARAM["coarse_len"] = 6
