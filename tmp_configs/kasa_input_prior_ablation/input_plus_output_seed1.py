...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "kasa_input_prior_ablation", "input_plus_output_seed1")
...
CFG.MODEL.PARAM["use_input_prior_enhancement"] = True
CFG.MODEL.PARAM["input_prior_mapper_type"] = 'mlp'
CFG.MODEL.PARAM["keep_output_prior_residual"] = True
