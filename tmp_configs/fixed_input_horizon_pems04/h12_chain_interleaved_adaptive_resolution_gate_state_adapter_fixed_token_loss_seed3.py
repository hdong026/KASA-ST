...
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 12
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_pems04/h12/chain_interleaved_adaptive_resolution_gate_state_adapter_fixed_token_loss_seed3")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["input_len"] = 12
CFG.MODEL.PARAM["output_len"] = 12
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 13))
CFG.MODEL.NAME = 'ChainForecasting_AdaptiveResolutionGate_TokenMAE'
...
CFG.MODEL.PARAM["use_adaptive_resolution_controller"] = True
CFG.MODEL.PARAM["adaptive_resolution_hidden_dim"] = 16
CFG.MODEL.PARAM["adaptive_resolution_gate_init"] = 0.98
CFG.MODEL.PARAM["adaptive_resolution_temporal_kernel"] = 3
CFG.MODEL.PARAM["adaptive_resolution_apply_to"] = 'forwarded_condition'
