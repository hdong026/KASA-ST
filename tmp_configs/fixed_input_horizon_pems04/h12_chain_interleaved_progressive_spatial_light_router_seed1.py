...
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 12
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_pems04/h12/chain_interleaved_progressive_spatial_light_router_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["input_len"] = 12
CFG.MODEL.PARAM["output_len"] = 12
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 13))
CFG.MODEL.NAME = 'ChainForecasting_LightSpectralRouter'
...
CFG.MODEL.PARAM["use_light_spectral_router"] = True
CFG.MODEL.PARAM["router_hidden_dim"] = 8
CFG.MODEL.PARAM["router_max_deviation"] = 0.05
CFG.MODEL.PARAM["router_shared_across_stages"] = True
