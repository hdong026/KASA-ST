...
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 12
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_pems04/h12/chain_adaptive_resolution_pondering_condition_adapter_token_loss_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["input_len"] = 12
CFG.MODEL.PARAM["output_len"] = 12
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 13))
CFG.MODEL.NAME = 'AdaptiveResolutionPonderingF2FNet'
from basicts.archs import AdaptiveResolutionPonderingF2FNet
CFG.MODEL.ARCH = AdaptiveResolutionPonderingF2FNet
CFG.MODEL.PARAM.pop("chain_lengths", None)
CFG.MODEL.PARAM.pop("temporal_resolution_candidates", None)
CFG.MODEL.PARAM.pop("spatial_resolution_candidates", None)
CFG.MODEL.PARAM.pop("graph_resolution_capacities", None)
CFG.MODEL.PARAM.pop("progressive_spatial_ratios", None)
CFG.MODEL.PARAM.pop("progressive_spatial_topks", None)
CFG.MODEL.PARAM.pop("progressive_spatial_alphas", None)
...
CFG.MODEL.PARAM["chain_loss_mode"] = 'dynamic_resolution_token'
CFG.MODEL.PARAM["chain_loss_weights"] = None
CFG.MODEL.PARAM["thinking_intensity"] = 0.5
CFG.MODEL.PARAM["controller_hidden_dim"] = 32
CFG.MODEL.PARAM["forecast_cell_hidden_dim"] = 32
CFG.MODEL.PARAM["controller_temperature"] = 1.0
CFG.MODEL.PARAM["controller_temperature_decay"] = 0.97
CFG.MODEL.PARAM["halt_threshold"] = 0.5
CFG.MODEL.PARAM["split_threshold"] = 0.5
...
CFG.MODEL.PARAM["budget_base"] = 0.35
CFG.MODEL.PARAM["budget_scale"] = 0.55
CFG.MODEL.PARAM["budget_dual_lr"] = 0.01
CFG.MODEL.PARAM["hierarchy_cache_dir"] = 'generated/cache/adaptive_resolution_hierarchies'
