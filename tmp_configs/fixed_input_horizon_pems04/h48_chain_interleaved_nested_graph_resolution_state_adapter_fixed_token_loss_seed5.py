...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_pems04/h48/chain_interleaved_nested_graph_resolution_state_adapter_fixed_token_loss_seed5")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["input_len"] = 12
CFG.MODEL.PARAM["output_len"] = 48
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 49))
CFG.MODEL.NAME = 'ChainForecasting_NestedGraphResolution_TokenMAE'
...
CFG.MODEL.PARAM["chain_lengths"] = [12, 24, 48]
...
CFG.MODEL.PARAM["spatial_placement"] = 'interleaved_graph_resolution'
CFG.MODEL.PARAM["graph_cluster_method"] = 'gr20_graclus_matching_4_2_1'
CFG.MODEL.PARAM["graph_resolution_capacities"] = [4, 2, 1]
CFG.MODEL.PARAM["graph_resolution_rhos"] = [0.25, 0.5, 1.0]
CFG.MODEL.PARAM["graph_resolution_topks"] = [8, 16, 32]
...
CFG.MODEL.PARAM["variant_name"] = 'nested_graph_resolution_fixed_token_loss'
