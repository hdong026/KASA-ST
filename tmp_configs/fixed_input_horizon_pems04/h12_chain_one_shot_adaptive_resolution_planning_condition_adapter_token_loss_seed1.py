...
CFG.DATASET_INPUT_LEN = 12
CFG.DATASET_OUTPUT_LEN = 12
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_pems04/h12/chain_one_shot_adaptive_resolution_planning_condition_adapter_token_loss_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.MODEL.PARAM["input_len"] = 12
CFG.MODEL.PARAM["output_len"] = 12
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 13))
CFG.MODEL.NAME = 'OneShotAdaptiveResolutionF2FNet'
from basicts.archs import OneShotAdaptiveResolutionF2FNet
CFG.MODEL.ARCH = OneShotAdaptiveResolutionF2FNet
...
CFG.MODEL.PARAM.pop("halt_threshold", None)
CFG.MODEL.PARAM.pop("controller_hidden_dim", None)
...
CFG.MODEL.PARAM["chain_loss_mode"] = 'one_shot_resolution_token'
CFG.MODEL.PARAM["chain_loss_weights"] = None
CFG.MODEL.PARAM["thinking_intensity"] = 0.5
CFG.MODEL.PARAM["planner_hidden_dim"] = 32
CFG.MODEL.PARAM["executor_hidden_dim"] = 32
CFG.MODEL.PARAM["planner_temperature"] = 1.0
...
CFG.MODEL.PARAM["budget_base"] = 0.15
CFG.MODEL.PARAM["budget_scale"] = 0.45
