...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_pems04/h48/chain_interleaved_progressive_spatial_light_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
...
CFG.MODEL.PARAM["progressive_spatial_topks"] = [4, 8, 16]
CFG.MODEL.PARAM["progressive_spatial_alphas"] = [0.02, 0.04, 0.08]
