...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/fixed_input_horizon_pems04/h48/chain_interleaved_progressive_spatial_strong_seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
...
CFG.MODEL.PARAM["progressive_spatial_ratios"] = [0.5, 0.75, 1.0]
CFG.MODEL.PARAM["progressive_spatial_topks"] = [16, 24, 40]
CFG.MODEL.PARAM["progressive_spatial_alphas"] = [0.05, 0.08, 0.12]
