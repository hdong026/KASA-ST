...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/gr7_stagewise/h32/FT/seed1")
CFG.DESCRIPTION = "GR7_stagewise PeMS04 h32 stage=FT seed1"
...
CFG.TRAIN.OPTIM.PARAM["lr"] = 0.0002
CFG.TRAIN.LR_SCHEDULER.PARAM["milestones"] = [1, 8, 12]
CFG.TRAIN.STAGEWISE = EasyDict()
CFG.TRAIN.STAGEWISE.enabled = True
CFG.TRAIN.STAGEWISE.stage = 'FT'
...
CFG.TRAIN.STAGEWISE.load_checkpoint = '/home/dhz/KASA-ST/checkpoints/gr7_stagewise/H32/seed1/S1.pt'
CFG.TRAIN.STAGEWISE.save_checkpoint = '/home/dhz/KASA-ST/checkpoints/gr7_stagewise/H32/seed1/FT.pt'
