...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/gr7_stagewise/h32/S14/seed1")
CFG.DESCRIPTION = "GR7_stagewise PeMS04 h32 stage=S14 seed1"
...
CFG.TRAIN.STAGEWISE.load_checkpoint = '/home/dhz/KASA-ST/checkpoints/gr7_stagewise/H32/seed1/T3_best.pt'
CFG.TRAIN.STAGEWISE.save_checkpoint = '/home/dhz/KASA-ST/checkpoints/gr7_stagewise/H32/seed1/S14_best.pt'
