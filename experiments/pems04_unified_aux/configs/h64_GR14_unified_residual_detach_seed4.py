...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 4
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/pems04_unified_aux/h64/GR14_unified_residual_detach/seed4")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "PeMS04 unified aux h64: GR14_unified_residual_detach seed4"
...
CFG.MODEL.PARAM["graph_resolution_ratios"] = [0.5, 1.0]
CFG.MODEL.PARAM["graph_resolution_alphas"] = [0.06, 0.1]
CFG.MODEL.PARAM["graph_resolution_topks"] = [8, 16]
CFG.MODEL.PARAM["graph_resolution_betas"] = [1.0, 1.0]
CFG.MODEL.PARAM["graph_resolution_rhos"] = [0.5, 1.0]
CFG.MODEL.PARAM["clustering_seed"] = 0
CFG.MODEL.PARAM["dataset_name"] = 'PEMS04'
CFG.MODEL.PARAM["graph_cluster_method"] = 'current'
CFG.MODEL.PARAM["aux_eta_temporal"] = 0.05
CFG.MODEL.PARAM["aux_eta_spatial"] = 0.03
CFG.MODEL.PARAM["aux_temporal_anchor_weight"] = 0.02
CFG.MODEL.PARAM["aux_temporal_power"] = 2.0
CFG.MODEL.PARAM["aux_spatial_power"] = 2.0
CFG.MODEL.PARAM["aux_include_spatial_final"] = False
CFG.MODEL.PARAM["aux_mono_margin"] = 0.0
CFG.MODEL.PARAM["unified_aux_loss_mode"] = 'unified_residual_detach'
