...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 3
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/pems04_unified_aux/h64/GR19a_cap_only_spectral_S12_cluster_mix/seed3")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "PeMS04 unified aux h64: GR19a_cap_only_spectral_S12_cluster_mix seed3"
CFG.MODEL.PARAM["variant_name"] = 'GR19a_cap_only_spectral_S12_cluster_mix'
...
CFG.MODEL.PARAM["post_spatial_mode"] = 'adaptive_cluster_mix'
CFG.MODEL.PARAM["graph_cluster_method"] = 'cap_only_spectral'
CFG.MODEL.PARAM["graph_cluster_affinity"] = 'adj_sym'
CFG.MODEL.PARAM["graph_resolution_capacities"] = [2]
CFG.MODEL.PARAM["graph_resolution_skip_final_identity"] = True
CFG.MODEL.PARAM["graph_resolution_alphas"] = [0.1]
CFG.MODEL.PARAM["graph_resolution_topks"] = [8]
CFG.MODEL.PARAM["graph_resolution_betas"] = [1.0]
CFG.MODEL.PARAM["graph_resolution_rhos"] = [0.5]
CFG.MODEL.PARAM["cluster_graph_mix_lambda"] = 0.5
