...
CFG.ENV.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/gr_capdist_final_primary/h32/seed1")
CFG.DESCRIPTION = "GR_capdist_final_primary PeMS04 h32 seed1"
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2]
CFG.MODEL.PARAM["input_dim"] = 3
CFG.MODEL.PARAM["main_input_dim"] = 3
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 33))
CFG.MODEL.PARAM["variant_name"] = 'GR_capdist_final_primary'
CFG.MODEL.PARAM["base_variant"] = 'GR7_capdist_mix'
CFG.MODEL.PARAM["spatial_placement"] = 'temporal_first_graph_resolution'
CFG.MODEL.PARAM["post_spatial_mode"] = 'adaptive_cluster_mix'
CFG.MODEL.PARAM["graph_cluster_method"] = 'capdist_spectral'
CFG.MODEL.PARAM["graph_resolution_ratios"] = [0.25, 0.5, 1.0]
CFG.MODEL.PARAM["graph_resolution_capacities"] = [4, 2, 1]
CFG.MODEL.PARAM["graph_resolution_topks"] = [4, 8, 16]
CFG.MODEL.PARAM["graph_resolution_alphas"] = [0.02, 0.08, 0.1]
CFG.MODEL.PARAM["graph_resolution_betas"] = [1.0, 1.0, 1.0]
CFG.MODEL.PARAM["graph_resolution_rhos"] = [1.0, 1.0, 1.0]
CFG.MODEL.PARAM["cluster_graph_mix_lambdas"] = [0.3, 0.5, 0.3]
CFG.MODEL.PARAM["capdist_sigma_d"] = 0.5
CFG.MODEL.PARAM["capdist_lambda_d"] = 0.05
CFG.MODEL.PARAM["capdist_use_hard_cutoff"] = False
CFG.MODEL.PARAM["capdist_use_road_distance"] = True
...
CFG.MODEL.PARAM["final_primary_grad_surgery"] = True
CFG.MODEL.PARAM["aux_grad_max_ratio"] = 0.2
