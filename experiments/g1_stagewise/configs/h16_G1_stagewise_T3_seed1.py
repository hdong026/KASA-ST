...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/g1_stagewise/H16/seed1/T3")
CFG.DESCRIPTION = "G1_stagewise PeMS04 h16 stage=T3 seed1"
...
CFG.TRAIN.STAGEWISE.load_checkpoint = '/home/dhz/KASA-ST/checkpoints/g1_stagewise/H16/seed1/T2_best.pt'
CFG.TRAIN.STAGEWISE.save_checkpoint = '/home/dhz/KASA-ST/checkpoints/g1_stagewise/H16/seed1/T3_best.pt'
