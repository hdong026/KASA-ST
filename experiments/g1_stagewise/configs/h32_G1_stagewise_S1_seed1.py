...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/g1_stagewise/H32/seed1/S1")
CFG.DESCRIPTION = "G1_stagewise PeMS04 h32 stage=S1 seed1"
...
CFG.TRAIN.OPTIM.PARAM["lr"] = 0.0005
...
CFG.TRAIN.STAGEWISE.load_checkpoint = '/home/dhz/KASA-ST/checkpoints/g1_stagewise/H32/seed1/T3_best.pt'
CFG.TRAIN.STAGEWISE.save_checkpoint = '/home/dhz/KASA-ST/checkpoints/g1_stagewise/H32/seed1/S1_best.pt'
