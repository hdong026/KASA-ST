...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/g1_stagewise/H32/seed1/T1")
CFG.DESCRIPTION = "G1_stagewise PeMS04 h32 stage=T1 seed1"
...
CFG.TRAIN.STAGEWISE.save_checkpoint = '/home/dhz/KASA-ST/checkpoints/g1_stagewise/H32/seed1/T1_best.pt'
