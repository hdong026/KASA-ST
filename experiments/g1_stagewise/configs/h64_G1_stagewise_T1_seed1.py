...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/g1_stagewise/H64/seed1/T1")
CFG.DESCRIPTION = "G1_stagewise PeMS04 h64 stage=T1 seed1"
...
CFG.MODEL.PARAM["chain_lengths"] = [16, 32, 64]
CFG.MODEL.PARAM["chain_loss_weights"] = [0.0, 0.0, 0.0]
CFG.TRAIN.OPTIM.PARAM["lr"] = 0.002
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 65))
...
CFG.TRAIN.STAGEWISE.save_checkpoint = '/home/dhz/KASA-ST/checkpoints/g1_stagewise/H64/seed1/T1_best.pt'
