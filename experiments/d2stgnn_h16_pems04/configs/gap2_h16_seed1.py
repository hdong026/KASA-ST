...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/d2stgnn_h16_pems04/gap2/h16/seed1")
CFG.DESCRIPTION = "D2STGNN PeMS04 16→16 gap=2 seed1"
...
CFG.MODEL.PARAM["output_seq_len"] = 16
CFG.MODEL.PARAM["seq_length"] = 16
