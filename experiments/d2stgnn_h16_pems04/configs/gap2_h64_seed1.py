...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/d2stgnn_h16_pems04/gap2/h64/seed1")
CFG.DESCRIPTION = "D2STGNN PeMS04 16→64 gap=2 seed1"
CFG.DATASET_INPUT_LEN = 16
CFG.DATASET_OUTPUT_LEN = 64
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 65))
CFG.MODEL.PARAM["gap"] = 2
CFG.MODEL.PARAM["input_seq_len"] = 16
CFG.MODEL.PARAM["output_seq_len"] = 64
CFG.MODEL.PARAM["seq_length"] = 64
CFG.TRAIN.CL.PREDICTION_LENGTH = 64
