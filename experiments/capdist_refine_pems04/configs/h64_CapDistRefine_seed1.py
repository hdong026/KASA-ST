...
from examples.CapDistRefine._capdist_refine_base import CAPDIST_REFINE_PARAM


CFG = EasyDict()

CFG.DESCRIPTION = "CapDistRefine on PeMS04 16→64"
...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/capdist_refine_pems04/h64/CapDistRefine/seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "PeMS04 CapDistRefine h64 seed1"
