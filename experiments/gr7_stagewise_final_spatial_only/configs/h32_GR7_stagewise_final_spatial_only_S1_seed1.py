...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/gr7_stagewise_final_spatial_only/h32/S1/seed1")
CFG.DESCRIPTION = "GR7_stagewise_final_spatial_only PeMS04 h32 stage=S1 seed1"
...
CFG.TRAIN.STAGEWISE.load_checkpoint = '/home/dhz/KASA-ST/checkpoints/gr7_stagewise_final_spatial_only/H32/seed1/T3_best.pt'
CFG.TRAIN.STAGEWISE.save_checkpoint = '/home/dhz/KASA-ST/checkpoints/gr7_stagewise_final_spatial_only/H32/seed1/S1_best.pt'
