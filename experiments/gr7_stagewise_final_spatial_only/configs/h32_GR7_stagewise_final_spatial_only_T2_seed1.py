...
# ===== GR7_stagewise_final_spatial_only overrides (auto-generated) =====
CFG.ENV.SEED = 1
CFG.TRAIN.NUM_EPOCHS = 40
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/gr7_stagewise_final_spatial_only/h32/T2/seed1")
CFG.DESCRIPTION = "GR7_stagewise_final_spatial_only PeMS04 h32 stage=T2 seed1"
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2]
CFG.MODEL.PARAM["input_dim"] = 3
CFG.MODEL.PARAM["main_input_dim"] = 3
CFG.MODEL.PARAM["variant_name"] = 'GR7_stagewise_final_spatial_only'
CFG.MODEL.PARAM["spatial_placement"] = 'temporal_first_graph_resolution'
CFG.MODEL.PARAM["post_spatial_mode"] = 'adaptive_only'
CFG.MODEL.PARAM["graph_resolution_ratios"] = [1.0]
CFG.MODEL.PARAM["graph_resolution_topks"] = [16]
CFG.MODEL.PARAM["graph_resolution_alphas"] = [0.1]
CFG.MODEL.PARAM["graph_resolution_betas"] = [1.0]
CFG.MODEL.PARAM["graph_resolution_rhos"] = [1.0]
...
CFG.MODEL.PARAM["spatial_stage_loss_weights"] = []
CFG.MODEL.PARAM["spatial_graph_loss_weights"] = []
...
CFG.TRAIN.STAGEWISE.stage = 'T2'
CFG.TRAIN.STAGEWISE.freeze_previous = True
CFG.TRAIN.STAGEWISE.detach_previous = True
CFG.TRAIN.STAGEWISE.stage_sequence = 'final_spatial_only'
CFG.TRAIN.STAGEWISE.train_shared_temporal = True
CFG.TRAIN.STAGEWISE.variant_name = 'GR7_stagewise_final_spatial_only'
CFG.TRAIN.STAGEWISE.ckpt_root = '/home/dhz/KASA-ST/checkpoints/gr7_stagewise_final_spatial_only'
CFG.TRAIN.STAGEWISE.load_checkpoint = '/home/dhz/KASA-ST/checkpoints/gr7_stagewise_final_spatial_only/H32/seed1/T1_best.pt'
CFG.TRAIN.STAGEWISE.save_checkpoint = '/home/dhz/KASA-ST/checkpoints/gr7_stagewise_final_spatial_only/H32/seed1/T2_best.pt'
