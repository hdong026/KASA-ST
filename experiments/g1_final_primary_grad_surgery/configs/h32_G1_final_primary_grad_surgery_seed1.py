...
CFG.ENV.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/g1_final_primary_grad_surgery/h32/seed1")
CFG.DESCRIPTION = "G1_final_primary_grad_surgery PeMS04 h32 seed1"
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2]
CFG.MODEL.PARAM["input_dim"] = 3
CFG.MODEL.PARAM["main_input_dim"] = 3
CFG.TEST.EVALUATION_HORIZONS = list(range(1, 33))
CFG.MODEL.PARAM["variant_name"] = 'G1_final_primary_grad_surgery'
