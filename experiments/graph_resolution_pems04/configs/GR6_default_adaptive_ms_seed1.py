...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/graph_resolution_pems04/GR6_default_adaptive_ms/seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "Graph Resolution ablation: GR6_default_adaptive_ms seed1"
...
CFG.MODEL.PARAM["post_spatial_mode"] = 'adaptive_multiscale_only'
...
CFG.MODEL.PARAM["adaptive_ms_topks"] = [8, 16, 32]
CFG.MODEL.PARAM["adaptive_ms_alpha"] = 0.1
CFG.MODEL.PARAM["adaptive_ms_fusion"] = 'softmax'
CFG.MODEL.PARAM["adaptive_ms_share_logits"] = True
CFG.MODEL.PARAM["adaptive_ms_init"] = 'favor_largest'
