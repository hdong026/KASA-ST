...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/graph_resolution_pems04/GR15_four_level_sparse_stageloss/seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "Graph Resolution ablation: GR15_four_level_sparse_stageloss seed1"
...
CFG.MODEL.PARAM["graph_resolution_ratios"] = [0.125, 0.25, 0.5, 1.0]
CFG.MODEL.PARAM["graph_resolution_alphas"] = [0.02, 0.04, 0.06, 0.1]
CFG.MODEL.PARAM["graph_resolution_topks"] = [2, 4, 8, 16]
CFG.MODEL.PARAM["graph_resolution_betas"] = [1.0, 1.0, 1.0, 1.0]
CFG.MODEL.PARAM["graph_resolution_rhos"] = [0.125, 0.25, 0.5, 1.0]
CFG.MODEL.PARAM["clustering_seed"] = 0
CFG.MODEL.PARAM["dataset_name"] = 'PEMS04'
CFG.MODEL.PARAM["graph_cluster_method"] = 'current'
CFG.MODEL.PARAM["spatial_graph_loss_weights"] = [0.1, 0.2, 0.3, 0.0]
