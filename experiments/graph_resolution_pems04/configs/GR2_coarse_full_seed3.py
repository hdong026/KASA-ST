...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 3
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/graph_resolution_pems04/GR2_coarse_full/seed3")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "Graph Resolution ablation: GR2_coarse_full seed3"
