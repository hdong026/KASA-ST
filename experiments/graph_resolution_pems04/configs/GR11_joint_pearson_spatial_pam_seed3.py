...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 3
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/graph_resolution_pems04/GR11_joint_pearson_spatial_pam/seed3")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "Graph Resolution ablation: GR11_joint_pearson_spatial_pam seed3"
...
CFG.MODEL.PARAM["graph_cluster_method"] = 'joint_pearson_spatial_balanced_pam'
CFG.MODEL.PARAM["cluster_lambda_s"] = 0.2
CFG.MODEL.PARAM["cluster_spatial_coord_path"] = 'datasets/raw_data/PEMS04/adj_PEMS04_distance.pkl'
