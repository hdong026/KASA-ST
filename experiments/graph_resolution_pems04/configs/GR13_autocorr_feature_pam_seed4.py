...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 4
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/graph_resolution_pems04/GR13_autocorr_feature_pam/seed4")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "Graph Resolution ablation: GR13_autocorr_feature_pam seed4"
...
CFG.MODEL.PARAM["graph_cluster_method"] = 'autocorr_feature_balanced_pam'
CFG.MODEL.PARAM["cluster_acf_lag"] = 24
