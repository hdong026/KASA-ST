...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 5
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/graph_resolution_pems04/GR10_xcorr_balanced_pam/seed5")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "Graph Resolution ablation: GR10_xcorr_balanced_pam seed5"
...
CFG.MODEL.PARAM["graph_cluster_method"] = 'xcorr_balanced_pam'
CFG.MODEL.PARAM["cluster_max_lag"] = 12
