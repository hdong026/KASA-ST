...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 2
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/graph_resolution_pems04/GR2_coarse_full/seed2")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "Graph Resolution ablation: GR2_coarse_full seed2"
...
CFG.MODEL.PARAM["graph_resolution_ratios"] = [0.25, 1.0]
CFG.MODEL.PARAM["graph_resolution_alphas"] = [0.04, 0.1]
CFG.MODEL.PARAM["graph_resolution_topks"] = [8, 32]
CFG.MODEL.PARAM["graph_resolution_betas"] = [1.0, 1.0]
CFG.MODEL.PARAM["graph_resolution_rhos"] = [0.25, 1.0]
