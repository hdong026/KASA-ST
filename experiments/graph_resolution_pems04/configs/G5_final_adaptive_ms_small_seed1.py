...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 1
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/graph_resolution_pems04/G5_final_adaptive_ms_small/seed1")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "Graph Resolution ablation: G5_final_adaptive_ms_small seed1"
...
CFG.MODEL.PARAM["adaptive_ms_topks"] = [4, 8, 16]
CFG.MODEL.PARAM["adaptive_ms_alpha"] = 0.08
