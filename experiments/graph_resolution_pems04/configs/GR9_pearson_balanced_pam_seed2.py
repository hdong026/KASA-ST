...
if hasattr(CFG, 'TRAIN') and hasattr(CFG.TRAIN, 'SEED'):
    CFG.TRAIN.SEED = 2
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints/graph_resolution_pems04/GR9_pearson_balanced_pam/seed2")
CFG.MODEL.FORWARD_FEATURES = [0, 1, 2, 3]
CFG.MODEL.TARGET_FEATURES = [0]
CFG.DESCRIPTION = "Graph Resolution ablation: GR9_pearson_balanced_pam seed2"
