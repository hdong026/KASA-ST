...
from basicts.archs.arch_zoo.KASA_arch_v3.patch_emb import PatchEncoder
from basicts.archs.arch_zoo.KASA_arch_v3.downsamp_emb import DownsampEncoder
from basicts.archs.arch_zoo.KASA_arch_v3.gcn import ABCDSpatialModule
...
class KASA_v3(nn.Module):
    def __init__(self, **model_args):
        super(KASA_v3, self).__init__()
        ...
        self.keep_output_prior_residual = model_args.get(
            ...
            model_args.get("use_prior_residual", False),
        )
        ...
        self.spatial_module = ABCDSpatialModule(
            ...
            use_cross_st_gate=model_args.get("use_cross_st_gate", False),
            use_spectral_decomp_gate=model_args.get("use_spectral_decomp_gate", False),
            gate_hidden=model_args.get("gate_hidden", 8),
        )
    ...
    def _lookup_weekly_template(self, future_data):
        ...
        template = self.weekly_spectral_template
        if template is None:
        ...
        prior = template[week_idx, node_idx, :]
