...
CFG.DESCRIPTION = "G1-self-replace on PeMS04 12→12 (Y_final = A_self Y_12)"
...
CFG.MODEL.PARAM = {
    ...
    # Only spatial-mode difference vs G1 / ChainForecasting_PEMS04.py:
    "post_spatial_mode": "adaptive_self_replace",
