...
CFG.DESCRIPTION = "G1-STAE-Spatial on PeMS04 12→12 (latent spatial self-attention)"
...
CFG.MODEL.PARAM = {
    ...
    # Spatial-mode difference vs G1 / ChainForecasting_PEMS04.py:
    "post_spatial_mode": "stae_spatial_attention",
    "spatial_attn_dim": 32,
