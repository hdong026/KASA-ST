...
CFG.DESCRIPTION = "G1_S12_capdist_final_primary on PEMS08 16→32"
...
CFG.MODEL.PARAM = {
    ...
    "clustering_seed": 0,
    "dataset_name": "PEMS08",
    "cluster_road_distance_path": "datasets/raw_data/PEMS08/adj_PEMS08_distance.pkl",
    "cluster_sigma_d": 0.5,
    "cluster_delta_4": 0.8,
    "cluster_delta_2": 0.5,
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    "checkpoints",
    "G1_S12_capdist_final_primary_PEMS08_16to32",
)
