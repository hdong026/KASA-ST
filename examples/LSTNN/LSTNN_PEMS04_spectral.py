...
CFG.DESCRIPTION = "LSTNN + spectral plugin on PEMS04"
...
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "MultiscaleMLP_spectral"
...
CFG.MODEL.PARAM = {
    ...
    "if_spatial": True,
    "num_layer": 2,
    "use_spectral_plugin": True,
    "spectral_num_bands": 4,
    "spectral_init_scale": 0.01,
}
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join("checkpoints", "MultiscaleMLP_spectral_100")
